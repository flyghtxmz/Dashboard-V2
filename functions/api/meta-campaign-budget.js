...
export async function onRequest({ request, env }) {
  ...
  const { campaign_id, daily_budget_brl } = body || {};
  if (!campaign_id || daily_budget_brl === undefined || daily_budget_brl === null) {
    return jsonResponse(400, {
      error: "Parametros obrigatorios: campaign_id, daily_budget_brl",
    });
  }
  ...
  try {
    ...
    return jsonResponse(200, { code: "success", data, campaign });
  } catch (error) {
