...
export async function onRequest({ request, env }) {
  ...
  if (!campaign_id || !status) {
    return jsonResponse(400, { error: "Parametros obrigatorios: campaign_id, status" });
  }
  ...
  try {
    ...
    return jsonResponse(500, { error: "Erro ao atualizar campanha", details: error.message });
  }
}
